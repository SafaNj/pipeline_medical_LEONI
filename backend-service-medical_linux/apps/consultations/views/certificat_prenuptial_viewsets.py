...
from apps.consultations.serializers import CertificatPrenuptialSerializer


class CertificatPrenuptialViewSet(SiteScopedQuerysetCreateMixin, viewsets.ModelViewSet):
    queryset = CertificatPrenuptial.objects.select_related("consultation")
    serializer_class = CertificatPrenuptialSerializer
    permission_classes = [
