...
from apps.consultations.serializers import CertificatPermisConduireSerializer


class CertificatPermisConduireViewSet(SiteScopedQuerysetCreateMixin, viewsets.ModelViewSet):
    queryset = CertificatPermisConduire.objects.select_related("consultation")
    serializer_class = CertificatPermisConduireSerializer
    permission_classes = [
