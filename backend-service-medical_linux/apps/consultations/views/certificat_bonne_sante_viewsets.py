...
from apps.consultations.serializers import CertificatBonneSanteSerializer


class CertificatBonneSanteViewSet(SiteScopedQuerysetCreateMixin, viewsets.ModelViewSet):
    queryset = CertificatBonneSante.objects.select_related("consultation")
    serializer_class = CertificatBonneSanteSerializer
    permission_classes = [
