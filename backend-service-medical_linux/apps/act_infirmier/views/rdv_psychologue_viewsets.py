...
from apps.act_infirmier.serializers import RendezVousPsychologueSerializer


class RendezVousPsychologueViewSet(SiteScopedQuerysetCreateMixin, viewsets.ModelViewSet):
    queryset = RendezVousPsychologue.objects.select_related("collaborateur", "infirmiere", "site")
    serializer_class = RendezVousPsychologueSerializer
